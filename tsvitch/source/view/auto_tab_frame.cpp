...
void AutoTabFrame::draw(NVGcontext* vg, float x, float y, float width, float height, brls::Style style,
...
void AutoTabFrame::onLayout() { View::onLayout(); }
...
void AttachedView::registerTabAction(std::string hintText, enum brls::ControllerButton button,
                                     brls::ActionListener action, bool hidden, bool allowRepeating,
