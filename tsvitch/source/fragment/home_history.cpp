...
void HomeHistory::onCreate() {
    // this->registerTabAction("tsvitch/home/common/refresh"_i18n, brls::ControllerButton::BUTTON_X,
...
//void HomeHistory::onRecommendVideoList(const bilibili::RecommendVideoListResultWrapper& originalResult) {
    // // 过滤up主
